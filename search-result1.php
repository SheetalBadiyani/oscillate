		   ...
		   if(isset($_REQUEST['action']) && $_REQUEST['action']=='show_result')
{
		   if($result >0)
			   ...
			   {
				   $image="admin/student_images/thumb2/".$row[8];
			   }
			   else
				{
					$image="admin/student_images/thumb2/image_not_found.jpg";
				}
			   ?>
                <div>&nbsp;</div>
                <div class="center-bg-inner1">
                  <table width="100%" border="1" cellspacing="0" cellpadding="0" rules="groups" background="#000000">
                  <tr valign="top">
                    <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr valign="top">
                        <td height="100"  colspan="3" align="center" valign="bottom"><img src="images/result-head.jpg" width="408" height="94" alt="" /></td>
                      </tr>
                      <tr valign="top">
                        <td colspan="3" class="exa-result-head">Examination Results</td>
                      </tr>
                      <tr valign="top">
                        <td>&nbsp;</td>
                        <td align="left">&nbsp;</td>
                      ...
                      <tr valign="top">
                        <td colspan="2" align="left"><span style="line-height:20px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Website :  
                          www.oscillateinstitute.com</span></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      <!--<tr valign="top">
