...
$MailToAddress = "saffron.technical@gmail.com"; // your email address.
$MailToAddress2 = "oscillate.technical@gmail.com";//second mail id 
$redirectURL = "thankyou.html"; // the URL of the thank you page.
$MailSubject = "Please Assist Me"; // the subject of the email
...
if (!$email) {$email = $MailToAddress;}
	...
	mail($MailToAddress2, $MailSubject, $mailMessage,$mailHeader);
