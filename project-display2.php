...
// query the database
$dbresult = "SELECT * FROM UploadData WHERE Name = 'Mahesh' ";

//Fetcj the results / convert results into an array
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="33%" rowspan="6" align="left" valign="top"><table width="75%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <a href="prop.php?imagpath=<?php echo  $rowStudentResult["StudImage"];?>" 
        title="<?php echo $rowStudentResult["compName"];?> in 
		       <?php echo $rowStudentResult["cityState"];?>" target="_blank">
     <img src="<?php echo $rowStudentResult["StudImage"];?>"
          alt="<?php echo $rowStudentResult["compName"];?> in
               <?php echo $rowStudentResult["cityState"];?>" 
               width="128" height="118" border="0" align="middle" id='img1' /></a></td>
      </tr>
    </table></td>
    <td width="33%" align="left" valign="top">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td width="33%" align="left" valign="top">&nbsp;</td>
    <td colspan="2" align="left" valign="top" style="padding:0 0 0 120px;">&nbsp;</td>
    </tr>
  <tr>
    <td width="33%" align="left" valign="top">&nbsp;</td>
    <td width="33%" align="left" valign="top">&nbsp;</td>
  ...
  <tr>
    <td height="23" colspan="3" align="left" valign="top" style="padding:0 0 0 110px;"><span class="ratebox-font" ><?php echo $rows["Name"];?></span></td>
    </tr>
  <tr>
    <td align="left" valign="top">&nbsp;</td>
    <td align="left" valign="top">&nbsp;</td>
