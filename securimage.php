...
class Securimage {
    ...
    */
    ...
    function Securimage()
    {
        ...
        $this->gd_font_size  = 28;
        $this->text_x_start  = 8;

        $this->ttf_file      = $this->basepath . '/AHGBold.ttf';

        $this->perturbation       = 0.50;
        $this->iscale             = 5;
        $this->text_angle_minimum = 1;
        $this->text_angle_maximum = 0;

        $this->image_bg_color   = new Securimage_Color(0xE4, 0xE4, 0xE4);
        $this->text_color       = new Securimage_Color(0x83, 0x23, 0x23);
        ...
        $this->num_lines            = 0;
        $this->line_color           = new Securimage_Color(0x00, 0x33, 0x66);
