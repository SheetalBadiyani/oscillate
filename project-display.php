...
// query the database
$dbresult = "SELECT * FROM UploadData WHERE Certificate_No Like '%111%' ";

//Fetch the results / convert results into an array

$result = mysql_query($dbresult,$link) or die("Internal Server Error:".mysql_error());               
$numresult=mysql_num_rows($result);
$rows = mysql_fetch_array($result);

			$Certificate_No = $rows['Certificate_No'];
			$Name= $rows["Name"];
			$Course= $rows["Course"];
			$PassingDate= $rows["PassingDate"];
			$Result= $rows["Result"];
			$Marks= $rows["Marks"];
			$Grade= $rows["Grade"];
			$StudImage= $rows["StudImage"];
...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <td width="33%" rowspan="6" align="left" valign="top"><table width="75%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="120" align="center" valign="middle">
            <img src="<?php echo $rows["StudImage"];?>"
            alt="<?php echo $rows["compName"];?> in
            <?php echo $rows["cityState"];?>" 
            width="128" height="118" border="0" align="middle" id='img1' />
        </td>
      </tr>
    </table></td>
    <td width="33%" align="left" valign="top">&nbsp;</td>
  ...
  <tr>
    <td width="33%" align="left" valign="top">&nbsp;</td>
    <td width="33%" colspan="2" rowspan="2" align="left" valign="middle" style="padding:0 0 10px 120px;"><span class="ratebox-font"><strong><?php echo $rows["Certificate_No"];?></strong></span></td>
    </tr>
  <tr>
    <td width="33%" align="left" valign="top">&nbsp;</td>
    </tr>
  ...
  <tr>
    <td height="23" colspan="3" align="left" valign="top" style="padding:0 0 0 120px;"><span class="ratebox-font" ><strong><?php echo $rows["Name"];?></strong></span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3" align="center" valign="top"><span class="ratebox-font"><strong><?php echo $rows["Course"];?></strong></span></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="top"><span class="ratebox-font"><?php echo $rows["PassingDate"];?></span></td>
    <td align="left" valign="top">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="3" align="left" valign="top" height="16"></td>
    </tr>
  <tr>
    <td align="left" valign="top">&nbsp;</td>
    <td align="left" valign="top">&nbsp;</td>
  ...
  <tr>
    <td colspan="2" align="left" valign="top"  style="padding:0 0 0 90px;"><span class="ratebox-font"><?php echo $rows["Result"];?></span></td>
    <td width="33%" align="left" valign="top">&nbsp;</td>
  </tr>
  <tr>
    <td width="33%" align="left" valign="top">&nbsp;</td>
  ...
  <tr>
    <td colspan="2" align="left" valign="top" style="padding:0 0 0 90px;"><span class="ratebox-font"><?php echo $rows["Marks"];?></span></td>
    <td width="33%" align="left" valign="top">&nbsp;</td>
  </tr>
  <tr>
    <td width="33%" align="left" valign="top">&nbsp;</td>
  ...
  <tr>
    <td colspan="2" align="left" valign="top" style="padding:0 0 0 90px;"><span class="ratebox-font"><?php echo $rows["Grade"];?></span></td>
    <td width="33%" align="left" valign="top">&nbsp;</td>
  </tr>
  <tr>
    <td width="33%" align="left" valign="top">&nbsp;</td>
